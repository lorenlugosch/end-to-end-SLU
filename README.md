...
Our paper describes [Fluent Speech Commands](http://www.fluent.ai/research/fluent-speech-commands/), a speech dataset for spoken language understanding released for free by [Fluent.ai](https://www.fluent.ai/). The paper also explores useful pre-training strategies for end-to-end spoken language understanding.
