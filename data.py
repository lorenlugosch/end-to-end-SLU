...
def get_datasets(base_path, config):
	...
	train_textgrid_paths = glob.glob(base_path + "/aligned/train*/*/*/*.TextGrid")
	...
	print(len(train_textgrid_paths))
	print(len(valid_textgrid_paths))
	print(len(test_textgrid_paths))
